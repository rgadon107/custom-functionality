...
<!-- wp:paragraph {"metadata":{"name":"Column Header Label-Topic"}} -->
...
<!-- wp:paragraph {"metadata":{"name":"Column Header Label-Presenter"}} -->
<p><strong>Presenter</strong></p><!-- /wp:paragraph --></div>
<!-- /wp:column -->
</div>
<!-- /wp:columns -->
